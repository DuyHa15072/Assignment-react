...
const Headers = (props: Props) => {
  return (
    ...
    <div className="container mx-auto px-4 py-8 flex items-center">
        {/* logo */}
        <div className="mr-auto md:w-[10rem] flex-shrink-0">
        <NavLink to={'/'}><img className="w-[72px] mx-auto" src="	https://jydesignforyou.files.wordpress.com/2014/05/coffee-logo.png?w=300&h=300" /></NavLink>
        </div>
        <div className=" md:w-[28rem] hidden sm:flex flex-col items-center">
        <nav>
                        <ul className="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                            ...
                            <li><NavLink className="inline-block no-underline hover:text-black hover:underline py-2 px-4" to="/products">Shop</NavLink></li>
        ...
        <ul className="ml-4 xl:w-48 flex items-center justify-end">
            ...
            <NavLink to={'/signin'}> <svg className="h-9 lg:h-10 p-2 text-gray-500" aria-hidden="true" focusable="false" data-prefix="far" data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M313.6 304c-28.7 0-42.5 16-89.6 16-47.1 0-60.8-16-89.6-16C60.2 304 0 364.2 0 438.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-25.6c0-74.2-60.2-134.4-134.4-134.4zM400 464H48v-25.6c0-47.6 38.8-86.4 86.4-86.4 14.6 0 38.3 16 89.6 16 51.7 0 74.9-16 89.6-16 47.6 0 86.4 38.8 86.4 86.4V464zM224 288c79.5 0 144-64.5 144-144S303.5 0 224 0 80 64.5 80 144s64.5 144 144 144zm0-240c52.9 0 96 43.1 96 96s-43.1 96-96 96-96-43.1-96-96 43.1-96 96-96z" /></svg></NavLink>
            </li>
            <li className="ml-2 lg:ml-4 relative inline-block">
            </li>
            <li className="ml-2 lg:ml-4 relative inline-block">
            <a>
                <div className="absolute -top-1 right-0 z-10 bg-yellow-400 text-xs font-bold px-1 py-0.5 rounded-sm">1</div>
